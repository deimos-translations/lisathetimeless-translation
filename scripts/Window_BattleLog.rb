...
class Window_BattleLog < Window_Selectable
    ...
    def added_state_message(enemy, state)
        case enemy.enemy_id
            # Дверца холодильника (25), Слот-машина
            when 22, 23, 25, 62, 63, 64, 65, 66, 67, 68, 69
                case state.id
                    when 2
                        return ' отравлена!'
                    when 113
                    ...
                    when 7
                        return ' напугана...'
                    when 27, 40
                        return ' тяжело отравлена!'
                    when 30
                        return ' парализована!'
                    when 46
                        return ' покрыта маслом!'
                    when 70
                        return ' напугана!'
                    when 72
                        return ' потеряла равновесие.'
                end
            # Перекати-поле (48), Болотное чудище (38)
            when 38, 48
                case state.id
                    when 2
                        return ' отравлено!'
                    ...
                    when 7
                        return ' напугано...'
                    when 27, 40
                        return ' тяжело отравлено!'
                    when 30
                        return ' парализовано!'
                    when 46
                        return ' покрыто маслом!'
                    when 70
                        return ' напугано!'
                    when 72
                        return ' потеряло равновесие.'
                end
        end
